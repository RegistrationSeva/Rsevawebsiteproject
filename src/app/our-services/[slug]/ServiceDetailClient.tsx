  ...
  return (
    <div>
      ...
      <p>
        ...
        than one hundred words. Search engines prefer useful sentences that
        describe services, products, or ideas. By writing clear paragraphs, we
        improve both the user experience and the way SEO tools analyze the site.
      </p>
      <p>
        Here we add additional text to ensure the overall word count exceeds
        seventy or even one hundred words. This gives you a realistic test
        environment to see how metadata, keyword density, and content length
        affect optimization reports. In production, this placeholder text should
        be replaced with high-quality descriptions about your business,
