      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-20">
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-lg shadow-lg">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-4 md:mb-6">
            Registration Seva is committed to protecting the privacy of our
            users (“you,” “your”). This Privacy Policy outlines how we collect,
            use, disclose, and protect your personal information when you use
            our website RegistrationSeva.com (the “Site”) and our services (the
            “Services”).
          </p>
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
            ...
            about your interactions with our Site, such as your IP address,
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
            ...
            process your requests, provide our services, and communicate with
            you.
          </p>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-4">
            <strong>To Send Marketing Communications:</strong> With your
            consent, we may send you promotional emails about our services. You
